# Masters of The Universe? (MoU) Dev Fund ZIP

    ZIP: Unassigned {numbers are assigned by ZIP editors}
    Title: Masters of The Universe?
    Owners: NoamChom (Zcash forum)
    Credit ZIP: "Hybrid Deferred Dev Fund" by Jason McGee
    <https://github.com/zcash/zips/pull/860>
    ...
    Title Credits: <https://www.versobooks.com/products/1684-masters-of-the-universe>
...
This proposal describes a structure for the Zcash MoU Development
Fund, to be enacted in Network Upgrade 6 and last for 4 years. This Dev Fund
would consist of 25% of the block subsidies, split into 2 slices:

* 17% to a MoU Dev Fund “lockbox,” which will be allocated in the future
  once consensus is reached on fund allocation or a new non-direct funding
  model is established and implemented.
* 8% to Zcash Community Grants (ZCG) to fund independent teams in the Zcash
  ecosystem.
...
For these reasons, the Zcash Community wishes to establish a Zcash MoU
Development Fund after the second halving in November 2024, and
allocate 17% of the block subsidies to MoU Dev Fund “lockbox” and 8% to Zcash
Community Grants.
...
* **Moving Towards a Non-Direct Funding Model**: There is strong community
  ...
  MoU Dev Fund Lockbox gives the community time to research and
  implement such a model while continuing to fund grant recipients.
  
* **Avoiding immediate miner allocation**: Without the MoU Dev
...
* **Promoting Decentralization**: Allocating a portion of the Dev Fund to Zcash
  ...
  lockbox, would disproportionally impact grant recipients. A hybrid
...
* 60% to a MoU Dev Fund “lockbox”.
* 40% to Zcash Community Grants to fund independent teams in the Zcash ecosystem.

### MoU Dev Fund Lockbox

<u>MoU Development Fund Chain Value Pool Balance</u>
...
added to the MoU development fund chain value pool balance and subtracted
...
MoU development fund must be defined to ensure the correct allocation at
every block.

<u>Proportion Specification</u>

The proportions of the block subsidy allocated to the MoU development fund
and any existing funding streams must add up to the intended total at every
block. Before NU6 activation, the actual percentage allocated to the MoU
development fund will be zero. After NU6 activation, 12% of the block
reward will be allocated to the MoU development fund.
...
that removes ZCG’s Dev Fund slice and allocates it to the MoU Dev Fund
lockbox.
